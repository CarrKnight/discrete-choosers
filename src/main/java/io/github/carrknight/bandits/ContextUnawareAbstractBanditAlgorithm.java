...
public abstract class ContextUnawareAbstractBanditAlgorithm<O,R> implements Chooser<O, R, Object> {
     ...
     */
    @NotNull
    private final Function<R,Double> rewardExtractor;
    ...
    public ContextUnawareAbstractBanditAlgorithm(
            @NotNull
                    ...
                    Function<R, Double> rewardExtractor,
            @NotNull
    ...
    public ContextUnawareAbstractBanditAlgorithm(
            @NotNull Function<R, Double> rewardExtractor, @NotNull O[] optionsAvailable,
    ...
    private void learnFromObservation(Observation<O, R, Object> observation) {
        ...
        double rewardObtained = rewardExtractor.apply(observation.getRewardObserved());
