...
/*
 * This class is copied from the BURLAP library which is covered by Apache license and it's available here:
 ...
 *
 *
 * it is only very slightly modified so that it takes random doubles from outside rather than having its own random generator
 */
